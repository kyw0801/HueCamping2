...
<!-- 안내바 S -->
  <div id="expath" class="path">
   <ol>
    ...
    <li>
     <a href="privacyManage.jsp"><strong>개인정보취급방침</strong></a>
    </li>
   </ol>
  </div>
<!-- 안내바 E -->

  <div class="guideLink_title">개인정보취급방침</div>
  <div class="guideMenu">
   <ul class="menucategory">
    <li><a href="guideLink_useTerms.net">이용약관</a></li>
    <li><a href="guideLink_privacyManage.net"><strong style="color: #222;">개인정보취급방침</strong></a></li>
    <li><a href="guideLink_useInfo.net">이용안내</a></li>  
   </ul>
  </div>
  <div class="guideLink_contentback">
   <div class="guideLink_content">
<br>  ** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한 내용을 반영하여 사용하시기 바랍니다. **<br><br>

휴:캠핑마켓은 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "개인정보 보호법" 등 관련 법령을 준수하고 있습니다.<br>
