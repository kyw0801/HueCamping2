  ...
  <div class="guideLink_title">QnA</div>
   <div class="guideMenu">
    <ul class="menucategory">
     ...
     <li><a href="noticeCenter_QnA.net">QnA</a></li> 
...
<form method="post" action="noticeCenter_product_QnA_edit.net?page=${page}" onsubmit="return okcancellist_btn_check();">
 <input type="hidden" name="board_no" value="${bc.board_no}">
 
 <table id="bCont_t">
  <tr>
   <th class="proQnAth" scope="row">제목</th>
   <td><input name="board_title" id="board_title" value="${bc.board_title}" /></td>
  </tr>
  
  <tr>
   <th class="proQnAth" scope="row">글쓴이</th>
   <td><input name="board_name" id="board_name" value="${bc.board_name}" /></td>
  </tr>
  ...
  <tr>
   <td class="pro_QnA_contcols" colspan="2">
    <textarea id="board_cont" name="board_cont">${bc.board_cont}</textarea>
   </td>
  </tr>
 </table>
