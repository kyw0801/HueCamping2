...
<div id="bReply_wrap">
<form method="post" action="noticeCenter_review_reply_ok.net" onsubmit="return replycont_btn_check()">
...
<div class="okcancellist_btn">
 ...
 onclick="location='noticeCenter_review_view.net?board_no=${rc.board_no}&page=${page}&state=cont';">
</div>
