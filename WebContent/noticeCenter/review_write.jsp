...
<form method="post" action="noticeCenter_review_write_ok.net" onsubmit="return okcancellist_btn_check();" enctype="multipart/form-data">
...
<div class="okcancellist_btn"> 
   ...
   <input class="product_QnA_btn" type="button" value="목록" 
            onclick="location='noticeCenter_review.net?page=${page}';" >
  </div>
 </form>
</div>
