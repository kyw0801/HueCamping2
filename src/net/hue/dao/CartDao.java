...
public class CartDao {
	...
	// 장바구니 목록
	public ArrayList<CartBean> getAllItem(int memno){
	...
	public int countItemInCart(int memno) { // 해당 사용자가 장바구니에 담고있는 상품의 행 개수 
		...
		try {
			// 3. SQL 작상 및 분석
			String sql = "select count(*) from cart where mno=" + memno;
			ps = conn.prepareStatement(sql);
